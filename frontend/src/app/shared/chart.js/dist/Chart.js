...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		updateElement: function(rectangle, index, reset) {
			...
			rectangle._view = rectangle._model;
			rectangle._start = null;
...
module.exports = function(Chart) {
	...
	Chart.controllers.line = Chart.DatasetController.extend({
		...
		updateElement: function(point, index, reset) {
			...
			/*
				Since we disabled the points.pivot(), point._view and point._start set to default values 
				which are used in point.draw()
			*/
			point._view = point._model;
			point._start = null;
		},
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		*/
		...
		update: function(config) {
			...
			/*
				both controller.reset() and me.updateDataset ends up calling the 
				controller.update. and cotroller.reset is required for animation
			*/
		...
		transition: function(easingValue) {
			...
			/* required for animation. default values for _view, _start are set in controller.update */
			/*
			for (var i = 0, ilen = (me.data.datasets || []).length; i < ilen; ++i) {
...
function parse(input, scale) {
	...
	/* converting the input to moment object takes time. instead just return the value */
	return scale.getRightValue(input);
	...
	var TimeScale = Chart.Scale.extend({
		...
		determineDataLimits: function() {
			...
			if (timestamps.length) {
				...
				/*
					arrayUnique and sorting takes time. Instead find the min, max in simple for loop
				*/
