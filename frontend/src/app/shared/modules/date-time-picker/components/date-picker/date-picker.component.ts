...
import { ECalendarMode } from '../../types/calendar-mode-enum';
...
import { INavEvent } from '../../models/models';
...
export class DatePickerComponent implements OnChanges,
    ...
    onViewDateChange(value: string) {
        ...
        if (this.dayPickerService.isValidInputDateValue(value, this.componentConfig)) {
            ...
            this.currentDateView = this.selected.length
                ...
                : this.currentDateView;
        // else, check if valid non-default format time
        } else {
    ...
    set selected(selected: Moment[]) {
        ...
        // else if, triggered when selecting date from calendar
    ...
    showCalendars() {
        ...
        this.hideStateHelper = true;
        if (this.disableFutureDates) {
            const configCopy = Object.assign({}, this.dayTimeCalendarConfig);
