...
export class KBNService {
  ...
  init() {
    this.valueFormats['short'] = function(): any {
      return 6;
    };
  }
  ...
  preciseNumber(desc: string, value: number, precision: number): number {
    ...
    // return this.valueFormats[desc](value, precision - numDigitsBeforeDecimal, precision - numDigitsBeforeDecimal);
    return this.valueFormats[desc]();
    // return 5;
  }
...
//   formatBuilders['fixedUnit'] = function(unit) {
//     return function(size, decimals) {
//       if (size === null) {
//         return '';
//       }
//       return this.toFixed(size, decimals) + ' ' + unit;
//     };
//   };
